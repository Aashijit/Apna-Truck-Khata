...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__all_image_khata__ = __webpack_require__(929);
...
var AllImageKhataPage = /** @class */ (function () {
    ...
    AllImageKhataPage.prototype.filterList = function (events) {
        ...
        this.filterimages = this.images.filter(function (wp) {
            if (_this.searchTerm != '') {
                return (wp.tag_cloud.toLowerCase().indexOf(_this.searchTerm.toLowerCase()) > -1);
            }
            else
                return _this.images;
        });
