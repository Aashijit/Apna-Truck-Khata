...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__document_renewal__ = __webpack_require__(957);
        ...
        if (this.bill_number == null) {
            this.rest.post(this.codes.GET_LAST_BILL_ID, data).then(function (resp) {
                if (resp['_ReturnCode'] == '0') {
                    ...
                    _this.bill_number = Number(_this.bill_number) + 1;
                }
            });
        }
    ...
    DocumentRenewalPage.prototype.updateBill = function () {
        ...
        this.rest.post(this.codes.UPDATE_DOCUMENT_BILL, data).then(function (resp) {
            ...
            if (resp['_ReturnCode'] == '0') {
                ...
                resp['data']['bill_number'] = _this.bill_number;
                _this.bill_number = Number(resp['data']['bill_number']) + 1;
                if (_this.img != null)
