...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mechanic_bill__ = __webpack_require__(974);
...
var MechanicBillPage = /** @class */ (function () {
    ...
    MechanicBillPage.prototype.selectVehicle = function () {
    ...
    MechanicBillPage.prototype.save = function () {
        ...
        this.rest.post(this.codes.ADD_EXPENSE_BILL, data).then(function (resp) {
            if (resp['_ReturnCode'] == '0') {
                ...
                _this.vehicle_number = "";
                _this.img = null;
                _this.bills.push(resp['data']);
                console.log(JSON.stringify(_this.bills));
