...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__upload_image__ = __webpack_require__(979);
...
var UploadImagePage = /** @class */ (function () {
    function UploadImagePage(navCtrl, navParams, view, cm, ldcontroller, rest, codes) {
    ...
    UploadImagePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["Component"])({
            selector: 'page-upload-image',template:/*ion-inline-start:"/Users/aashijitmukhopadhyay/Documents/ApnaTruckKhata/src/pages/upload-image/upload-image.html"*/'<ion-content padding style="background: rgba(0,0,0,0.6);">\n\n  <p style="text-align: right !important;">\n    <button ion-button clear (click)="close()" style="font-size: 2rem; color: red;">\n      <ion-icon name="close"></ion-icon>\n    </button>\n  </p>\n\n<p style="text-align: center !important;margin-top: 50%;">\n  <button ion-button round (click)="camera()" style="width: 50%;height: 100px;font-size: 5rem;">\n    <ion-icon name="camera"></ion-icon>\n  </button>\n</p>\n<p style="text-align: center !important;">\n  <button ion-button round  (click)="gallery()" style="width: 50%;height: 100px;font-size: 5rem;">\n    <ion-icon name="image"></ion-icon>\n  </button>\n</p>\n\n</ion-content>\n'/*ion-inline-end:"/Users/aashijitmukhopadhyay/Documents/ApnaTruckKhata/src/pages/upload-image/upload-image.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["NavController"], __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["NavParams"],
            __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["ViewController"], __WEBPACK_IMPORTED_MODULE_2__ionic_native_camera__["a" /* Camera */], __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["LoadingController"],
            __WEBPACK_IMPORTED_MODULE_1__providers_rest_rest__["a" /* RestProvider */], __WEBPACK_IMPORTED_MODULE_0__providers_codes_codes__["a" /* CodesProvider */]])
    ], UploadImagePage);
