...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vehicle_document_bill__ = __webpack_require__(998);
    ...
    function VehicleDocumentBillPage(navCtrl, navParams, codes, rest, modalCtrl, viewC, ldc) {
        ...
        if (this.action == 'edit') {
            ...
            for (var i = 0; i < this.details.length; i++) {
                ...
                this.details[i]['image_url'] = this.details[i]['image_id'] != undefined ? this.details[i]['image_id'] : null;
            }
            this.changeCost();
        }
    }
