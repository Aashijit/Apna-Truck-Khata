...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__complaints_khata__ = __webpack_require__(944);
    ...
    ComplaintsKhataPage.prototype.clickedsearchitem = function (sr) {
        ...
        if (sr['type'] == 'driver') {
            ...
            for (var i = 0; i < this.complaints.length; i++) {
                alert(this.complaints[i]['driver']['driver_id'] + " " + sr['id'] + " " + sr['name'] + "   --- " + JSON.stringify(this.complaints[i]['driver']));
