...
var VehicleDocumentPage = /** @class */ (function () {
    ...
    VehicleDocumentPage.prototype.openCalendarPopup = function (type, documentName) {
        var _this = this;
        ...
        calendarModalPage.onDidDismiss(function (data) {
            for (var i = 0; i < _this.documents.length; i++) {
                if (_this.documents[i]['document_name'] == documentName) {
                    if (type == 'expiry') {
                        _this.documents[i]['document_expiry_date'] = localStorage.getItem(_this.codes.DATE);
                    }
                    else {
                        _this.documents[i]['document_reminder_date'] = localStorage.getItem(_this.codes.DATE);
                    }
                }
            }
        });
    ...
    VehicleDocumentPage.prototype.uploadPhoto = function (dc) {
        var data = {
        ...
        var cameraModalPage = this.modalCtrl.create('UploadImagePage', { "request": data2, 'image': irl });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vehicle_document__ = __webpack_require__(1002);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
