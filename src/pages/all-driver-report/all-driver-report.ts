...
@IonicPage()
@Component({
  selector: 'page-all-driver-report',
  templateUrl: 'all-driver-report.html',
})
export class AllDriverReportPage {
  ...
  generateReport() {
    ...
    this.rest.post(this.codes.ALL_DRIVER_REPORT, data).then(resp => {
      console.log(resp);
