...
@IonicPage()
@Component({
  selector: 'page-document-bill-report',
  templateUrl: 'document-bill-report.html',
})
export class DocumentBillReportPage {
  ...
  generateReport(){
    ...
    this.rest.post(this.codes.DOCUMENT_BILL_REPORT,data).then(resp => {
      console.log(resp);
